...
docker rm store 
docker build . -f 2021.Dockerfile -t contabilidad_2021
docker run -p 4000:4000 --name store -v $(pwd)/docs:/doc contabilidad_2021 bash -c 'jekyll build . && cp * /doc -r && chown 1000:1000 /doc -R'

#docker run -p 4000:4000 --volumes-from store -v $(pwd)/docs:/doc contabilidad_2021 bash -c 'cd /doc && jekyll serve'
